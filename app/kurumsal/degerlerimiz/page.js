        ...
        <section className='py-20'>
            ...
            <div className='container mx-auto mt-20 px-5 lg:px-0 '>
                ...
                <div className='mt-10'>
                    ...
                    <p className='text-neutral-900 mt-10 text-[1em]' data-aos="fade-right" data-aos-duration="200">
                        Normoil Filtrasyonda ki tüm çalışanlarımla aynı gemide olmanın bilinciyle birlikte; şirketimize ve ülkemize katkı sağlamak üzere müşterek çalışmayı, ‘’Benim işim’’den çok ‘’Bizim işimiz’’ düşüncesi ile çoğulculuğu ve katılımcılığı desteklemek, tüm çalışanların kimliklerine, bilgi birikimlerine, yetenek ve tecrübelerine saygı duymak,
                    </p>
                </div>
                <div className='mt-10'>
            ...
            <div className='bg-[#f9f9f9] py-20 mt-20'>
                <div className='container mx-auto px-5 lg:px-0 '>
                    ...
                    <div className='mt-20'>
                        <h3 className='text-xl font-medium text-neutral-900' data-aos="fade-right" data-aos-duration="200">Normoil Filtrasyon Etik Kurallar</h3>
                        <p className='text-neutral-900 mt-10 text-[1em]' data-aos="fade-right" data-aos-duration="200">
                    ...
                    <div className='mt-10'>
                        <h3 className='text-xl font-medium text-neutral-900' data-aos="fade-right" data-aos-duration="200">Normoil Filtrasyon İş Etiği Kuralları</h3>
                        <p className='text-neutral-900 mt-10 text-[1em]' data-aos="fade-right" data-aos-duration="200">
                            Etik Çalışma Kuralları, şirketin temel davranış ilkelerini içermektedir. Yasal, toplumsal ve ekonomik koşullarda meydana gelen değişimlerin yanı sıra Normoil Filtrasyon’un değerlerini de içerir. Şirket personeli, görevlerini yerine getirirken “İş Etiği İlkelerine” uymak zorundadır. İş prosedürleri, kanun ve düzenlemeler, her türlü tutum ve davranışımızla yön gösterici olamayacağı bilinciyle, şirket değerlerimiz üzerinde kurulmuş olan iş etiği kurallarımız bulunur.
                        </p>
                    </div>
                </div>
            </div>
            <div className='py-20 mt-20'>
                <div className='container mx-auto px-5 lg:px-0 '>
                    <h3 className='text-2xl font-medium text-neutral-900' data-aos="fade-right" data-aos-duration="200">Normoil Filtrasyon Etik Kurallar</h3>
                    <div className='mt-10'>
                        ...
                        <p className='text-neutral-900 mt-5 text-[1em]' data-aos="fade-right" data-aos-duration="200">
                            Normoil Filtrasyon’un İş Etiği Kuralları, Şirket politikaları, değerleri ve ilkeleri ile bütünlük içindedir. Yöneticiler dahil tüm çalışanların Normoil Filtrasyon İş Etiği Kurallarına uyması gerekir.
                        </p>
                        ...
                        <p className='text-neutral-900 mt-5 text-[1em]' data-aos="fade-right" data-aos-duration="200">
                            Normoil Filtrasyon; ortaklarına, çalışanlarına, tedarikçilerine, iş ortaklarına, rakiplerine, çevre, toplum ve insanlığa karşı güvenilirlik ve saygınlık göstergesi olarak çalışmayı hedefler. Dürüstlük, sadakat ve güvenilirlik, çalışanlarımızın Normoil Filtrasyon faaliyetleri üzerinde de etkisi olabilecek, şirket yönetimi tarafından izin verilmiş, özel faaliyetlerinin de vazgeçilmez ilkelerdendir. Çalışanlarımız şirket hedeflerine ulaşırken  yasalara, uluslararası hukuk kurallarına ve ahlak değerlerine uygun hareket eder.
                        </p>
                        ...
                        <p className='text-neutral-900 mt-5 text-[1em]' data-aos="fade-right" data-aos-duration="200">
                           <strong>c.1.</strong> Normoil Filtrasyon tarafından sağlanan veya iș yerinde ulaşma ya da öğrenme olasılığı bulunan bilgi ve dokümanlar, ticari sırlar, kamuya açıklanmamıș mali ve diğer bilgiler, çalıșanların özlük haklarına ait ve üçüncü șahıslarla yapılmıș anlașmalardaki gizli bilgiler, gizlilik ve ticari sırların korunması çerçevesinde değerlendirilir. 
                        </p>
                        <p className='text-neutral-900 mt-5 text-[1em]' data-aos="fade-right" data-aos-duration="200">
                           <strong>c.2.</strong> Normoil Filtrasyon, çalıșanlarına ve tüm paydașlarına ait kișisel bilgilerin korunmasına itina gösterir. Bu kapsamda bütün personelin özlük bilgileri ve șirket adına yapılan tüm elektronik posta yazıșmaları kayıt altına alınır. Normoil Filtrasyon, çalıșanlarına ait kișisel bilgilere ve özel yașama müdahale etmez. Personele ait bilgiler sadece gereksinim durumunda belirlenen yetkiler dahilinde, yetkili kișilerce Normoil’in amaçları doğrultusunda kullanılır.  
                        </p>
                        <p className='text-neutral-900 mt-5 text-[1em]' data-aos="fade-right" data-aos-duration="200">
                            <strong>c.3.</strong> Normoil Filtrasyon‘a ait her türlü gizli bilgi ve/veya belgenin “Insider Trading” (içeriden öğrenenlerin ticareti) kapsamında içeriden sızdırılarak, borsa veya herhangi bir yolla menfaat elde edilmesi kesinlikle kabul edilmez.  
                        </p>
                        <p className='text-neutral-900 mt-5 text-[1em]' data-aos="fade-right" data-aos-duration="200">
                        ...
                        <p className='text-neutral-900 mt-5 text-[1em]' data-aos="fade-right" data-aos-duration="200">
                            <strong>e.4.</strong> Normoil Filtrasyon Topluma ve Çevreye Karşı Sorumlulukların bilinci ile hareket eder. İnsan sağlığı, işletme güvenliği, çevrenin korunması standartlarını sürekli geliştirme ilkelerine sadık kalarak hareket eder.  
                        </p>
                        <p className='text-neutral-900 mt-5 text-[1em]' data-aos="fade-right" data-aos-duration="200">
                        ...
                        <p className='text-neutral-900 mt-5 text-[1em]' data-aos="fade-right" data-aos-duration="200">
                            <strong>e.7.</strong> Normoil Filtrasyon çevrenin ve doğal hayatın korunması, tüketici hakları ve kamu sağlığı konularında duyarlı olur ve kurallara uyar. 
                        </p>
                        <p className='text-neutral-900 mt-5 text-[1em]' data-aos="fade-right" data-aos-duration="200">
                            <strong>e.8.</strong> Normoil Filtraşyon, en yüksek seviyede müşteri memnuniyeti sağlayacak şekilde tüm müşterilerine karşı dürüst ve adil davranır. Müşterilerinin problemlerine karşı duyarlı davranır, hızlı ve kalıcı çözümler üreterek, en üst seviyede müşteri güvenini hedefler. Sadece verebileceği ürün ve hizmetleri sunmayı teklif eder ve taahhütlerini yerine getirmek için gerekli çabayı gösterir. 
                        </p>
                        <p className='text-neutral-900 mt-5 text-[1em]' data-aos="fade-right" data-aos-duration="200">
                            <strong>e.9.</strong> Normoil Filtrasyon, mali disiplin ve hesap verebilirlik anlayışıyla, kaynak ve varlıkların en verimli şekilde yönetilmesini sağlar. Şirket hisse değerini maksimize etmeyi hedefleyen Normoil Filtrasyon gereksiz ve yönetilemez risklerden kaçınarak, büyüme odaklı , kârlı ve değer yaratan şirket stratejilerini uygular. Görevlendirilenler dışında hiçbir çalışan Normoil Filtrasyon ‘a temsilen sözlü ya da yazılı açıklamada bulunamaz. 
                        </p>
                        <p className='text-neutral-900 mt-5 text-[1em]' data-aos="fade-right" data-aos-duration="200">
                            <strong>e.10.</strong> Normoil Filtrasyon, ırk, etnik köken, milliyet, din ve cinsiyet ayrımı yapmaz. Eşit koșullardaki kișilere eşit fırsat sağlar. Ücretlendirme, tayin ve terfide performans ve verimlilik kriterlerini esas alır. Tüm süreçlerde şeffaf politikalar izler . Verilen görevleri yerine getirebilmeleri için gerekli yetkinliğe ve niteliklere uygun olanları yönetici seçer.  Çalışanlara güvenli ve sağlıklı bir çalışma ortamı sağlar.  Çalışanların bireysel ve mesleki konularda  eğitilmesini sağlar. Çalışanlarının birbirleriyle karşılıklı güven, saygı ve nezaket kuralları çerçevesinde iletişim kurmalarını ve işbirliği yapmalarını bekler.  Çalışanlarının karar alma sürecine katılımlarını sağlar.
                        </p>
                        <p className='text-neutral-900 mt-5 text-[1em]' data-aos="fade-right" data-aos-duration="200">
                        ...
                        <p className='text-neutral-900 mt-5 text-[1em]' data-aos="fade-right" data-aos-duration="200">
                            <strong>e.12.</strong> Normoil Filtrasyon çalışanları sosyal medya üzerinden girilen iletişimlerde dürüst olur ve kişisel bilgiler hakkında yanıltıcı beyanlarda bulunmaktan kaçınır. Sosyal medya araçları vasıtasıyla girilen iletişimlerin yansımaları konusunda, Normoil Filtrasyon çalıșanları olarak, bilinçli olur. Normoil Filtrasyon ile ilgili beyanda bulunma hakkı, Şirket yetkilileri ve kurullarına ait olduğundan, internet ortamında, herhangi bir biçimde Normoil Filtrasyon adına beyanda ya da sorumluluk doğuracak yorumda bulunulmaması gerektiğini bilir. Her yerde olduğu gibi, sosyal medya araçları vasıtasıyla girilen iletişimlerde de hukuka aykırı olabilecek hiçbir davranış içine girilmemesi ve söylemde bulunulmaması gerektiği bilincindedir. Bu çerçevede, Normoil Filtrasyon’un bir mensubu olarak, sosyal medya üzerinden gerçekleștirilen tüm fiil ve söylemlerden, bu fiil ve söylemleri yapanların şahsen sorumlu olduğunu daima dikkate alır ve hukuken Normoil Filtrasyon adına beyanda bulunulmasa dahi, Normoil Filtrasyon çalışanı olunduğu anlaşılıyorsa, yapılan bu hukuka aykırı eylemden dolayı Normoil Filtrasyon’un kamuoyu önünde itibarının olumsuz yönde etkilenebileceğini bilir. İşbu sosyal medya etik kurallarının ihlalinin, Normoil Filtrasyon‘un kamuoyu nezdinde itibarının ve/veya kurumsal kimliğinin olumsuz yönde etkilenmesi sonucunu doğurması halinde ve/veya mevzuattan kaynaklanan diğer sebeplerle, bu ihlali gerçekleştiren Normoil Filtrasyon çalıșanlarının iş ilişkisi üzerinde hukuki bazı olumsuz yansımaları olabileceği konusunda bilinçli olunmalı ve hatta bu hareket ve davranıșın niteliğine göre, bașkaca hukuki ve/veya cezai sonuçlarla karșılașılabileceği hususunu bilir. Normoil Filtrasyon çalıșanları sosyal medya araçlarındaki tüm paylașımlarından kanun ve yönetmelikler nezdinde bireysel sorumlu olduğunu bilir, olası cezai uygulamaların șirketi değil; eylemde bulunan bireyi bağladığını kabul eder ve sorumluluğunu bireysel tașır. Normoil Filtrasyon, bahsi geçen hatalı uygulamalarda alınan cezai yaptırımlardan sorumlu değildir/tutulamaz.
                        </p>
                        ...
                        <p className='text-neutral-900 mt-5 text-[1em]' data-aos="fade-right" data-aos-duration="200">
                            <strong>f.1.</strong> Normoil Filtrasyon çalışanları görevlerini eşitlikçi, şeffaf, hesap verebilir ve sorumlu şekilde yürütür.  
                        </p>
                        <p className='text-neutral-900 mt-5 text-[1em]' data-aos="fade-right" data-aos-duration="200">
                        ...
                        <p className='text-neutral-900 mt-5 text-[1em]' data-aos="fade-right" data-aos-duration="200">
                            <strong>f.12.</strong> Normoil Filtrasyon çalıșanları görevlerini eșitlikçi, șeffaf, hesap verebilir ve sorumlu șekilde yürütür.
                        </p>
                        <p className='text-neutral-900 mt-5 text-[1em]' data-aos="fade-right" data-aos-duration="200">
            ...
            <div className='bg-[#f9f9f9] py-20 mt-20'>
                <div className='container mx-auto px-5 lg:px-0'>
                    ...
                    <div className='text-neutral-900 mt-20 text-[1em]' data-aos="fade-right" data-aos-duration="200">
                        Normoil Filtrasyon Teknolojileri, tüm faaliyetlerinde insanı en değerli varlığı olarak kabul eder ve daha güvenli ve sağlıklı bir çalışma ortamı yaratarak, oluşabilecek her türlü kayıpları en aza indirmeyi öncelikli iş hedefi olarak benimser. İş sağlığı ve güvenliği yönetim sistemi; Normoil Filtrasyon Teknolojileri, çalışanların sağlık düzeylerinin geliştirilmesi, iş veriminin gereği olarak görülür. İş Sağlığı ve Güvenliği Yönetim Sistemi uygulanarak, sistem periyodik olarak gözden geçirilir ve performansı izlenerek, sürekli olarak gelişmesi sağlanır. Bu amaçla; <br /><br />
